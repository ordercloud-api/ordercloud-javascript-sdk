...
(function(root, factory) {
  ...
  describe('PriceSchedules', function() {
    ...
    describe('DeletePriceBreak', function() {
      it('should call DeletePriceBreak successfully', function(done) {
        //uncomment below and update the code to test DeletePriceBreak
        //instance.DeletePriceBreak(pet, function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('SavePriceBreak', function() {
      it('should call SavePriceBreak successfully', function(done) {
        //uncomment below and update the code to test SavePriceBreak
        //instance.SavePriceBreak(pet, function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
