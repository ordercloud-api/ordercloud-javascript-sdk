...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OrderCloud.Shipments();
  });
  ...
  describe('Shipments', function() {
    ...
    describe('SaveItem', function() {
      it('should call SaveItem successfully', function(done) {
        //uncomment below and update the code to test SaveItem
        //instance.SaveItem(pet, function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
