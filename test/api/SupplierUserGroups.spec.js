...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = OrderCloud.SupplierUserGroups;
  });
  ...
  describe('SupplierUserGroups', function() {
    ...
    describe('DeleteUserAssignment', function() {
      it('should call DeleteUserAssignment successfully', function(done) {
        //uncomment below and update the code to test DeleteUserAssignment
        //instance.DeleteUserAssignment(pet, function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('ListUserAssignments', function() {
      it('should call ListUserAssignments successfully', function(done) {
        //uncomment below and update the code to test ListUserAssignments
        //instance.ListUserAssignments(pet, function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('SaveUserAssignment', function() {
      it('should call SaveUserAssignment successfully', function(done) {
        //uncomment below and update the code to test SaveUserAssignment
        //instance.SaveUserAssignment(pet, function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
