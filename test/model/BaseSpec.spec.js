...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OrderCloud.BaseSpec();
  });
  ...
  describe('BaseSpec', function() {
    it('should create an instance of BaseSpec', function() {
      // uncomment below and update the code to test BaseSpec
      //var instane = new OrderCloud.BaseSpec();
      //expect(instance).to.be.a(OrderCloud.BaseSpec);
    });
