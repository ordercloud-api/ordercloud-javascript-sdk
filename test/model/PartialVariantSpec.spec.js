...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OrderCloud.PartialVariantSpec();
  });
  ...
  describe('PartialVariantSpec', function() {
    it('should create an instance of PartialVariantSpec', function() {
      // uncomment below and update the code to test PartialVariantSpec
      //var instane = new OrderCloud.PartialVariantSpec();
      //expect(instance).to.be.a(OrderCloud.PartialVariantSpec);
    });
