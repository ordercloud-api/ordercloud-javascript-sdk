...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OrderCloud.VariantSpec();
  });
  ...
  describe('VariantSpec', function() {
    it('should create an instance of VariantSpec', function() {
      // uncomment below and update the code to test VariantSpec
      //var instane = new OrderCloud.VariantSpec();
      //expect(instance).to.be.a(OrderCloud.VariantSpec);
    });
