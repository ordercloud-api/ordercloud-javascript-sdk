...
apiInstance.Update(meUser).then(function(data) {
  console.log('API called successfully. Returned data: ' + data);
}, function(error) {
  console.error(error);
});
...
# **UpdateAddress**
> BuyerAddress UpdateAddress(addressID, buyerAddress)
...
apiInstance.UpdateAddress(addressID, buyerAddress).then(function(data) {
  console.log('API called successfully. Returned data: ' + data);
}, function(error) {
  console.error(error);
});
...
# **UpdateCreditCard**
> BuyerCreditCard UpdateCreditCard(creditcardID, buyerCreditCard)
...
apiInstance.UpdateCreditCard(creditcardID, buyerCreditCard).then(function(data) {
  console.log('API called successfully. Returned data: ' + data);
}, function(error) {
  console.error(error);
});
