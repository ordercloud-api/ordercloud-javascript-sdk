...
class CookieApi {
    ...
    public write(name: string, value: string = undefined, options: CookieOptions) {
    ...
    public buildCookieString(name: string, value: string = undefined, options: CookieOptions) {
        let expires
        if (!value) {
