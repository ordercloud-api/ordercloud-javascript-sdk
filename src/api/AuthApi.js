...
(function(root, factory) {
    if (typeof define === 'function' && define.and) {
        ...
        root.OrderCloud.AuthApi = factory(root.OrderCloud.ApiClient, root.OrderCloud.AccessToken);
    }
    ...
    var exports = function(apiClient) {
        ...
        this.Login = function(username, password, clientID, scope) {
            ...
            var postPody = 'grant_type=password&scope=' + scope.join("+") + '&client_id=' + clientId + '&username=' + username + '&password=' + password;
            ...
            return this.apiClient.callAuth(
                '/oauth/token', 'POST',
                pathParams, queryParams, headerParams, formParams, postPody,
        ...
        this.ElevatedLogin= function(clientSecret, username, password, clientID, scope) {
            ...
            var postPody = 'grant_type=password&scope=' + scope.join("+") + '&client_secret=' + clientSecret + '&client_id=' + clientId + '&username=' + username + '&password=' + password;
        ...
        this.ClientCredentials = function(clientSecret, clientID, scope) {
            ...
            var postPody = 'grant_type=client_credentials&scope=' + scope.join("+") + '&client_secret=' + clientSecret + '&client_id=' + clientId;
        ...
        this.RefreshToken = function(refreshToken, clientID, scope) {
            ...
            var postPody = 'grant_type=refresh_token&scope=' + scope.join("+") + '&refresh_token=' + refreshToken + '&client_id=' + clientId;
        ...
        this.Anonymous = function(clientID, scope) {
            ...
            var postPody = 'grant_type=client_credentials&scope=' + scope.join("+") + '&client_id=' + clientId;
