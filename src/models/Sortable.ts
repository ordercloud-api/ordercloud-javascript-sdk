...
'Bundles.List': string[]
'BuyerGroups.List': ('Name' | 'ID' | '!Name' | '!ID')[]
'Buyers.List': ('ID' | 'Name' | 'GroupID' | 'DateCreated' | '!ID' | '!Name' | '!GroupID' | '!DateCreated')[]
...
'Discounts.List': ('ID' | 'CatalogID' | 'CategoryID' | 'ProductID' | 'Priority' | '!ID' | '!CatalogID' | '!CategoryID' | '!ProductID' | '!Priority')[]
